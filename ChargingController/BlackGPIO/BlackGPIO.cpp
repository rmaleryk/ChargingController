...
namespace BlackLib
{
    ...
    BlackCoreGPIO::BlackCoreGPIO(gpioName pin, direction dir)
    {
	    ...
	    std::cout << "[BlackLib] GPIOCore was loaded" << std::endl;
    }

    BlackCoreGPIO::~BlackCoreGPIO()
    {
	    std::cout << "[BlackLib] GPIOCore was unloaded" << std::endl;
        this->doUnexport();
    ...
    BlackGPIO::BlackGPIO(gpioName pin, direction dir, workingMode wm) : BlackCoreGPIO(pin, dir)
    {
	    ...
	    std::cout << "[BlackLib] GPIO was loaded" << std::endl;
    }

    BlackGPIO::~BlackGPIO()
    {
	    std::cout << "[BlackLib] GPIO was unloaded" << std::endl;
